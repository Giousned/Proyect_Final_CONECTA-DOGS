                                ...
                                <div class="card-3d-wrap mx-auto">
                                    <div class="card-3d-wrapper">
                                        <div class="card-front">
                                            <div class="center-wrap">
                                                <div class="section text-center">
                                                    <h4 class="mb-4 pb-3 text-white">Iniciar Sesión</h4>
                                        ...
                                        <div class="card-back">
                                            <div class="center-wrap">
                                                <div class="section text-center">
                                                    <h4 class="mb-4 pb-3 text-white">Registrase</h4>
                                                    <div class="form-group">
                                                        <input type="radio" id="propietario" name="age" value="propietario" />
                                                        <label for="propietario">Propietario</label>
                                                        <input type="radio" id="cuidador" name="age" value="cuidador" />

  ...
  return (
    <>
      ...
      <div className="container p-4">
        ...
        >
          ...
          <li className="nav-item" role="presentation">
            <button
              className="nav-link"
              id="reserveInformationDog"
              data-bs-toggle="pill"
              data-bs-target="#pills-dog"
              type="button"
              role="tab"
              aria-controls="pills-dog"
              aria-selected="false"
            >
      ...
      <div className="p-4">
        <Link
          to="/reserves"
          className="action-button shadow animate yellow text-center"
        >
          Ir Atrás
        </Link>
      </div>

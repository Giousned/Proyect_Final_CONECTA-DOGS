              ...
              return (
                <div className="card-form" key={index}>
                  ...
                  <div className="card-form__inner text-center">
                    ...
                    <h6 className="m-2 p-1">
                      <i className="fas fa-sun fa-xl"></i>{" "}
                      {book.tariff.service.title}
                    </h6>
                    <h6 className="m-2 p-1">
                    ...
                    <h6 className="m-2 p-1">
                      ...
                      Monto a pagar: <b>{book.tariff.price}</b>{" "}
...
export default ReserveCardByMe;
